        ...
        <div className="grid gap-8 lg:grid-cols-2">
          ...
          <div className="space-y-6">
            ...
            <p className="text-sm text-center text-text">
              🔒 الدفع آمن ومشفّر بواسطة Stripe
            </p>
          ...
          <div className="flex flex-col items-center justify-center">
            <div className="mb-6 text-center">
              <h2 className="mb-2 text-2xl font-bold text-heading">
                ادفع بواسطة Apple Pay
              </h2>
              <p className="text-text">
                شاهد كيفية الدفع بواسطة Apple Pay من Apple مباشرة
              </p>
            </div>
            
            <div className="w-full max-w-sm">
              <Iphone
                iframeSrc="https://www.apple.com/apple-pay/how-to/#video-pay-online"
                className="mx-auto"
              />
            </div>
